...
class LocalizationTeeth(TaskConfig):
    ...
    def infer(self) -> Union[InferTask, Dict[str, InferTask]]:
        task: InferTask = lib.infers.LocalizationTeeth(
            path=self.path,
    ...
    def trainer(self) -> Optional[TrainTask]:
        ...
        task: TrainTask = lib.trainers.LocalizationTeeth(
            ...
            description="Train teeth localization Model",
            labels=self.labels,
        )
        return task
