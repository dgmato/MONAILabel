...
class SegmentationMandible(TaskConfig):
    def init(self, name: str, model_dir: str, conf: Dict[str, str], planner: Any, **kwargs):
        ...
        self.labels = {
            "mandible": 1,
            "left inferior alveolar nerve": 36,
            "right inferior alveolar nerve": 37,
        }
    ...
    def infer(self) -> Union[InferTask, Dict[str, InferTask]]:
        task: InferTask = lib.infers.SegmentationMandible(
            path=self.path,
    ...
    def trainer(self) -> Optional[TrainTask]:
        ...
        task: TrainTask = lib.trainers.SegmentationMandible(
            ...
            description="Train mandible segmentation model",
            labels=self.labels,
        )
        return task
