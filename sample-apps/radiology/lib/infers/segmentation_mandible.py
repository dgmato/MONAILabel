...
class SegmentationMandible(BasicInferTask):
    """
    This provides Inference Engine for pre-trained mandible segmentation (SegResNet) model.
    """
    ...
    def __init__(
        ...
        labels=None,
        dimension=3,
        description="A pre-trained model for volumetric (3D) mandible segmentation from CT image",
        **kwargs,
    ):
        super().__init__(
            path=path,
