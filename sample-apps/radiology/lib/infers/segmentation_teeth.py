...
class SegmentationTeeth(BasicInferTask):
    """
    This provides Inference Engine for pre-trained teeth segmentation (UNet) model.
    """
    ...
    def __init__(
        ...
        labels=None,
        dimension=3,
        description="A pre-trained model for volumetric (3D) teeth segmentation from CT image",
        **kwargs,
    ):
        super().__init__(
            path=path,
